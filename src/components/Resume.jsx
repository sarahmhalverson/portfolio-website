      ...
      <div className="resume-container">
        ...
        >
          <div className="resume-card">
            ...
            <a href="/resumes/resume-data-analyst.pdf" download className="resume-btn resume-btn-dark">
              download ↓
            </a>
          </div>
          ...
          <div className="resume-card">
            ...
            <a href="/resumes/resume-frontend.pdf" download className="resume-btn resume-btn-outline">
              download ↓
            </a>
          </div>
